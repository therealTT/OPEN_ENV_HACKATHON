...
Scoring:
  1 — visited correct doc (DOC-001) + starting_dose correct
...
def grade(session: SessionState) -> tuple[float, str]:
    ...
    if correct_dose and visited_correct_doc:
        return 1, "Correct starting dose extracted from the correct document."
    ...
    return 0, f"Incorrect value and/or wrong document. Got: '{submitted_dose}'."
